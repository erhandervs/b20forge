...
export function Header({ onMenuClick }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-20 flex items-center justify-between px-3 sm:px-4 md:px-6 h-15 py-2 sm:py-3 bg-[#071114]/95 backdrop-blur-sm border-b border-[#1B2A32]">
